...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2019 at 01:37 PM
...
(1, 'A1', 28, 'S2', 'UB', 12, 'SUDAH', 5, 1),
(2, 'A2', 32, 'S3', 'JAPAN UNIVERSITY', 12, 'SUDAH', 7, 1),
(3, 'A3', 26, 'S2', 'Universitas Muhammadiyah Malang', 6, 'BELUM', 12, 1),
(4, 'A4', 27, 'S2', 'Politeknik Negeri Malang', 0, 'BELUM', 4, 1),
(5, 'A5', 39, 'S2', 'Institute Teknologi Sepuluh November', 24, 'SUDAH', 2, 1);
...
INSERT INTO `kelompok_kriteria` (`kelompok_kriteria_id`, `name`, `jenis`, `range_1`, `nilai_r1`, `range_2`, `nilai_r2`, `range_3`, `nilai_r3`, `range_4`, `nilai_r4`, `range_5`, `nilai_r5`, `is_active`) VALUES
(1, 'Usia', 'Kurang Dari', '30', 5, '35', 4, '40', 3, '45', 2, '50', 1, 1),
(2, 'Pendidikan Terakhir', 'Harus Sama Dengan', 'S3', 5, 'S2', 3, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(3, 'Pengalaman Kerja', 'Kurang Dari', '0', 1, '6', 2, '12', 3, '18', 4, '50', 5, 1),
(4, 'Status', 'Harus Sama Dengan', 'SUDAH', 3, 'BELUM', 5, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(5, 'Jarak', 'Kurang Dari', '5', 5, '8', 4, '13', 3, '15', 2, '30', 1, 1);
...
--
ALTER TABLE `bobot_kriteria`
  MODIFY `bobot_kriteria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `calon_pegawai`
--
ALTER TABLE `calon_pegawai`
  MODIFY `calon_pegawai_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
